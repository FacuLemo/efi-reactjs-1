...
class Drawclass extends Component{
    ...
    render(){
        ...
        let headerHeight = 40; 
        let lineHeightY = this.props.data.attributes.length * 35 + 37; // Cálculo de linea divisoria.                   
    ...
    getLongerWord(){
        ...
        let classname = this.props.data.name;
        let content = attributes.concat(methods).concat(classname);
        let greaterWidth = 0;
